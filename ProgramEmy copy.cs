...
namespace myDotNetApp
{
    class ProgramEmyAllMp3
    {
        ...
        private static readonly IAudioService audioService = new FFmpegAudioService(); // default audio library

        static async Task Maind(string[] args)
        {
            Console.WriteLine("Find with Emy mp3");
            ...
            string fullFfpmSOng = "full-ffpm.mp3";
            ...
            string safidikoSong = "safidiko.mp3";
            try
            {
